...
#define XTAL			  			48000000L	// in hertz
...
#define SERIAL_TX_BUFF_LENGTH		32 // used as a buffer for MIDI outputs
...
// jlabs MAWZER RECOGNIZED SYSEXS (RECEIVED BY MAWZER)

// jlabs MAWZER RECOGNIZED SYSEXS (SENT BY MAWZER)
