...
// USB MIDI IN  IS ON ENDPOINT 2 (OUT2)
// USB MIDI OUT IS ON ENDPOINT 4 (IN4)

/*
#define USB_IN_USES_ENDPOINT			1 // 2

#if USB_IN_USES_ENDPOINT == 1
#define USB_IN_ID				IN1BUF_ID 	// use endpoint 1
#define USB_IN_BUFFER			EP1INBUF 	// IN1BUF		// use endpoint 1
...
#define USB_IN_BUFFER			EP2INBUF 	// IN2BUF		// use endpoint 2
